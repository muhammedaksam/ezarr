...
class ContainerConfig:
    def __init__(self,
        ...
        self.torrent_dir = root_dir + '/media/downloads/torrent'
        self.usenet_dir = root_dir + '/media/downloads/usenet'
    ...
    def tautulli(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/tautulli:/config\n'
            '    ports:\n'
            '      - "8181:8181"\n'
            '    restart: unless-stopped\n\n'
        )
    ...
    def jellyfin(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/jellyfin:/config\n'
    ...
    def readarr(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/readarr:/config\n'
            '      - ' + self.root_dir + '/data:/data\n'
            '    ports:\n'
            '      - "8787:8787"\n'
            '    restart: unless-stopped\n\n'
    ...
    def prowlarr(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/prowlarr:/config\n'
            '    ports:\n'
            '      - "9696:9696"\n'
            '    restart: unless-stopped\n\n'
        )
    ...
    def overseerr(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/overseerr:/app/config\n'
            '    ports:\n'
            '      - "5055:5055"\n'
            '    restart: unless-stopped\n\n'
        )
    ...
    def jackett(self):
        return (
            ...
            '      - TZ=' + self.timezone + '\n'
            '    volumes:\n'
            '      - ' + self.config_dir + '/jackett:/config\n'
            '    ports:\n'
            '      - 9117:9117\n'
            '    restart: unless-stopped\n\n'
        )
